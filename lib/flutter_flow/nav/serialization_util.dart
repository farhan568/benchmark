    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case AssignedRow:
            return AssignedRow(data);
          case RequestedservicesRow:
            return RequestedservicesRow(data);
          case ProductsRow:
            return ProductsRow(data);
          case TblUsersRow:
            return TblUsersRow(data);
          case TblMembersRow:
            return TblMembersRow(data);
          case ServicesRow:
            return ServicesRow(data);
          case DepartmentRow:
            return DepartmentRow(data);
          case PolicyRow:
            return PolicyRow(data);
          case TestaRow:
            return TestaRow(data);
          case ChecklistRow:
